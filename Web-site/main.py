...
def account():
    return make_response(render_template("account/base.html"))
...
def account_referrals():
    return make_response(render_template("account/referral-program/referral-list.html"))

@app.route("/account-referral-charges", methods = ["POST"])
def account_charges():
    return make_response(render_template("account/referral-program/charges.html"))
